...
class CraigslistEnvironment(Language_Environment):
    def __init__(self, data: CraigslistData,
    ...
    def step(self, action: str) -> Tuple[CraigslistObservation, float, bool]:
        ...
        return CraigslistObservation(self.parent, action, reward), reward, True
    ...
    def reset(self) -> CraigslistObservation:
        ...
        return CraigslistObservation(self.parent, None, None)
