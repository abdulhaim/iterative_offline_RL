...
class TopAdvantageUtterances(Evaluator):
    def __init__(self, data: CraigslistDataset) -> None:
        self.data = data
...
class Utterance_Craigslist_IQL_Evaluator(Evaluator):
    def __init__(self, env: Language_Environment, verbose: bool, kind: str, **generation_kwargs) -> None:
        super().__init__()
        self.env = env
        self.verbose = verbose
...
class Craigslist_DT_Evaluator(Evaluator):
    def __init__(self, env: Language_Environment, verbose: bool, kind: str, **generation_kwargs) -> None:
        super().__init__()
        self.env = env
        self.verbose = verbose
...
class Craigslist_Chai_Evaluator(Evaluator):
